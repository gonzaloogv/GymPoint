...
function toListGymReviewsQuery(gymId, queryParams, userId = null) {
  ...
  return new ListGymReviewsQuery({
    ...
    sortBy,
    order,
    min_rating: queryParams.min_rating ? Number.parseFloat(queryParams.min_rating) : null,
    max_rating: queryParams.max_rating ? Number.parseFloat(queryParams.max_rating) : null,
...
function toGymRatingStatsResponse(stats) {
  return {
    ...
    avg_cleanliness: stats.avg_cleanliness ? Number.parseFloat(stats.avg_cleanliness) : null,
    avg_equipment: stats.avg_equipment ? Number.parseFloat(stats.avg_equipment) : null,
    avg_staff: stats.avg_staff ? Number.parseFloat(stats.avg_staff) : null,
    avg_facilities: stats.avg_facilities ? Number.parseFloat(stats.avg_facilities) : null,
    avg_value: stats.avg_value ? Number.parseFloat(stats.avg_value) : null,

...
INSERT INTO `SequelizeMeta` VALUES ('20250925-add-logo-url-to-gyms.js'),('20251004-create-accounts-and-profiles.js'),('20251005-migrate-existing-users.js'),('20251006-redirect-fks-to-user-profiles.js'),('20251007-complete-fk-migration.js'),('20251008-rewards-snapshot-and-indexes.js'),('20251009-reward-gym-stats-daily.js'),('20251010-add-created-by-to-exercise.js'),('20251011-fix-missing-fks.js'),('20251012-cleanup-and-add-fks.js');
...
INSERT INTO `frequency` VALUES (2,0,2,3,0);
...
INSERT INTO `streak` VALUES (2,2,0,2,NULL,0);
...
INSERT INTO `user` VALUES (1,'Gonzalo','gonzalo@example.com','Gomez','M','Buenos Aires',23,610,'PREMIUM',NULL,'$2b$10$kjWfjftU9RkPVyM3pl7jhehDcJO00/2HrVP7cEe1wdVsiPRReo.kW'),(2,'Admin','admin@gympoint.com','Principal','M','Resistencia',30,100,'ADMIN',2,'$2b$10$7IUQtRTXQF3xg1/evFC9JeEobV1Ew781vkaddTrYY7uBowcmUYHYi');
...
-- Dump completed on 2025-10-06  3:15:34

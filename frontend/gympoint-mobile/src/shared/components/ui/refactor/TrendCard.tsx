...
interface TrendCardProps {
  ...
  /** Si se proporciona, muestra el icono con este color */
  iconColor?: string;
}

/**
 * TrendCard - Tarjeta para mostrar métricas con tendencias
 *
 * Muestra un valor actual, su cambio respecto a un valor anterior (delta),
 * y el porcentaje de cambio. Los colores se ajustan automáticamente según
 * si valores más altos o más bajos son mejores.
 *
 * @example
 * ```tsx
 * <TrendCard

  ...
  return (
    <div className="space-y-6 p-6 bg-card dark:bg-card-dark rounded-xl border border-border dark:border-border-dark">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="flex items-center gap-2">
          <input type="checkbox" name="trial_allowed" id="trial_allowed" checked={formData.trial_allowed || false} onChange={handleInputChange} className="h-4 w-4 rounded border-input-border dark:border-input-border-dark bg-input-bg dark:bg-input-bg-dark text-primary focus:ring-primary" />
          <label htmlFor="trial_allowed" className="text-text dark:text-text-dark font-medium text-sm">
            🎁 Permite pase gratis por 1 día
          </label>
        </div>
      </div>
    </div>

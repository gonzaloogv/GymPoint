...
- useRealtimeSync (admin) alinea los query keys reales de TanStack Query y actualiza las listas sin perder filtros; tambi�n dispara toasts mediante RealtimeToastPortal.
...
- Documentaci�n nueva: docs/realtime_audit.md, realtime_test_plan.md, realtime_howto.md.
